*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOE_V002
*   generation date: 10.04.2020 at 15:36:26
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOE_V002            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOE_V002'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOE_V002_EXTRACT
TOTAL = ZOE_V002_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOE_V002'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOE_V002-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOE_V002_EXTRACT
TOTAL = ZOE_V002_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOE_V002-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOE_V002'
...
TOTAL = ZOE_V002_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOE_V002-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOE_V002-UPD_FLAG NE SPACE.
