*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZOE_V001
*   generation date: 04.03.2020 at 11:29:34
*   view maintenance generator version: #001407#
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZOE_V001            .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZOE_V001'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZOE_V001_EXTRACT
TOTAL = ZOE_V001_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZOE_V001'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZOE_V001-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZOE_V001_EXTRACT
TOTAL = ZOE_V001_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZOE_V001-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZOE_V001'
...
TOTAL = ZOE_V001_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZOE_V001-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZOE_V001-UPD_FLAG NE SPACE.
